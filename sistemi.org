...
**** SOLUZIONE
considerare (:<something>:) come [[]] con la stessa espressione dentro.
...
Domana sul problema della ridodanza: il PCB non contiene dei PUNTATORI a delle aree 
...
e non vanno ad intaccare il kernel. Si usano soltanto i processi , i
thread sono essenzialmente delle funzioni.
...
Si possono assegnare diverse risorse ai singolo alberi.
